        ...
        >
          <GlassCard>
            ...
            <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
              With a strong foundation in Industrial and Production Engineering
              from RUET and intensive MERN training from Programming Hero, I
              bring analytical thinking and clean code practices to every
              project I touch.
            </p>
          </GlassCard>
